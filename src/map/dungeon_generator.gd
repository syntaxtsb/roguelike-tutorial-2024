...
func _place_entities(dungeon: MapData, room: Rect2i, current_floor: int) -> void:
	...
	var monsters: Array[String] = _get_entites_at_random(enemy_chances, number_of_monsters, current_floor)
	var items: Array[String] = _get_entites_at_random(item_chances, number_of_items, current_floor)
...
func _get_entites_at_random(weighted_chances_by_floor: Dictionary, number_of_entities: int, current_floor: int) -> Array[String]:
